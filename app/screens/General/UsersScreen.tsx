...
const UsersScreen = ({ navigation }: any) => {
    ...
    const pingUser = (listedUserId, listedUsername, listedUserFullName, listedUserAvatar, listedUserEmail) => {
        ...
        navigation.navigate('FriendProfile', { user: { id: listedUserId, name: listedUsername, full_name: listedUserFullName, avatar: listedUserAvatar, email: listedUserEmail }  });
    ...
    const pingUserOffline = (listedUserId, listedUsername, listedUserFullName, listedUserAvatar, listedUserEmail) => {
        // console.log('derp');
        ...
        return (
            <View style={styles.userItem}>
                {item.enablepublicprofile ? (
                    <Pressable
                        onPress={() => pingUser(item?.id, item?.username, item?.full_name, item?.avatar_url, item?.email)}  // Pass listed user id to pingUser
                        style={{
                            display: 'flex',
                            flexDirection: 'row',
                            alignItems: 'center',
                    ...
                    <Pressable
                        onPress={() => pingUser(item?.id, item?.username, item?.full_name, item?.avatar_url, item?.email)}  // Pass listed user id to pingUserOffline
                        style={{
                            display: 'flex',
                            flexDirection: 'row',
                            alignItems: 'center',
